...
class MarkUp3DExtension extends Autodesk.Viewing.Extension {
    constructor(viewer, options) {
        ...
        this.raycaster.params.PointCloud.threshold = 10;//5 -default // hit-test markup size.  Change this if markup 'hover' doesn't work
        this.size = 75.0; //50 - default// markup size.  Change this if markup size is too big or small
        this.lineColor = 0x0000FF//0xffffff - default; // white
        this.labelOffset = new THREE.Vector3(5, 5, 5); //'new THREE.Vector3(10, 10, 10)' -default// label offset 3D line offset position
        this.xDivOffset = -0.1; //'-0.1'default //x offset position of the div label wrt 3D line.
        this.yDivOffset = 0.2; //'0.3'// y offset position of the div label wrt 3D line.
    ...
    `;
        ...
        this.sampleData = [{
            ...
            {
                "name": "Разгрузка с железной дороги из порта краном",
                "picture": "https://storage.yandexcloud.net/svf/razgruzkapoezda.jpg",
                "icon": 0,
                "position": {
                    "x": 100.000,
                    "y": 30.000,
            ...
            {
                "name": "Ричтрак для каждого контейнера!",
                "picture": "https://storage.yandexcloud.net/svf/richtracker.jpg",
                "icon": 0,
                "position": {
                    "x": 40.000,
                    "y": 5.000,
            ...
            },
           {
                ...
                "picture": "https://storage.yandexcloud.net/svf/kontainersite.jpg",
                "icon": 0,
                "position": {
                    "x": -30.000,
                    "y": 10.000,
            ...
            {
                "name": "Разгрузка поезда ричтракером",
                "picture": "https://storage.yandexcloud.net/svf/trackerrazgruzka.jpg",
                "icon": 0,
                "position": {
                    "x": -5.000,
                    "y": 40.000,
